...
min_distance = min([manhattan_distance((0,0), point) for point in intersections if point != (0,0)])

print("Part 1:", min_distance)

min_steps = min([wire1.index(point) + wire2.index(point) for point in intersections if point != (0,0)])
